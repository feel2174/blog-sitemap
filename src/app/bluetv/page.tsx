...
export const metadata = {
 title: '무료 스포츠중계 블루티비 - 실시간 고화질 스포츠 중계',
 description: 'PC와 모바일에서 실시간으로 끊김 없이 고화질로 즐기는 무료 스포츠중계 블루티비. 해외축구, MLB, NBA 등 전 세계 모든 스포츠 중계.',
};

export default function BlueTVPage() {
 return (
 <div
 ...
 @keyframes glow-text {
 0%, 100% { text-shadow: 0 0 10px rgba(0, 204, 255, 0.5), 0 0 20px rgba(0, 204, 255, 0.3); }
 50% { text-shadow: 0 0 20px rgba(0, 204, 255, 0.8), 0 0 30px rgba(0, 204, 255, 0.6), 0 0 40px rgba(0, 204, 255, 0.4); }
 }
 .glass-panel {
 ...
 <span className="text-[#00ccff] text-[13px] font-[800] tracking-wide">LIVE SPORTS STREAMING</span>
 </div>
 <h1 
 className="text-[36px] sm:text-[42px] font-[900] m-0 mb-3 tracking-[-2px] text-white leading-[1.1]"
 >
 무료 스포츠중계<br/>
 <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0066ff] to-[#00ccff]" style={{ animation: 'glow-text 2s infinite' }}>블루티비</span> 라운지
 </h1>
 ...
 {/* 장식용 그라데이션 */}
 <div className="absolute top-[-50%] left-[-10%] w-[120%] h-[120%] bg-[radial-gradient(ellipse_at_center,rgba(0,102,255,0.15)_0%,rgba(0,0,0,0)_70%)] pointer-events-none"></div>
 ...
 style={{ background: 'linear-gradient(135deg, #0066ff, #0044cc)', border: '2px solid #3388ff', animation: 'pulse-neon 1.8s infinite' }}
 >
 ...
 keyword="스포츠 의류" 
 title="🏆 승리를 부르는 퍼포먼스"
 hookText="블루티비로 스포츠 중계 보면서 운동 욕구 뿜뿜! 격렬한 움직임도 편안하게 지원하는 최신 스포츠 웨어와 홈트레이닝 장비 리스트입니다."
 />

...
const zodiacSigns = [
    { name: '쥐띠', year: '자(子)', years: '48, 60, 72, 84, 96, 08', emoji: '🐭', color: 'bg-emerald-500/10 hover:bg-emerald-500/20', borderColor: 'border-emerald-500/30' },
    { name: '소띠', year: '축(丑)', years: '49, 61, 73, 85, 97, 09', emoji: '🐮', color: 'bg-amber-500/10 hover:bg-amber-500/20', borderColor: 'border-amber-500/30' },
    { name: '호랑이띠', year: '인(寅)', years: '50, 62, 74, 86, 98, 10', emoji: '🐯', color: 'bg-orange-500/10 hover:bg-orange-500/20', borderColor: 'border-orange-500/30' },
    { name: '토끼띠', year: '묘(卯)', years: '51, 63, 75, 87, 99, 11', emoji: '🐰', color: 'bg-rose-500/10 hover:bg-rose-500/20', borderColor: 'border-rose-500/30' },
    { name: '용띠', year: '진(辰)', years: '52, 64, 76, 88, 00, 12', emoji: '🐲', color: 'bg-teal-500/10 hover:bg-teal-500/20', borderColor: 'border-teal-500/30' },
    { name: '뱀띠', year: '사(巳)', years: '53, 65, 77, 89, 01, 13', emoji: '🐍', color: 'bg-green-500/10 hover:bg-green-500/20', borderColor: 'border-green-500/30' },
    { name: '말띠', year: '오(午)', years: '54, 66, 78, 90, 02, 14', emoji: '🐴', color: 'bg-red-500/10 hover:bg-red-500/20', borderColor: 'border-red-500/30' },
    { name: '양띠', year: '미(未)', years: '55, 67, 79, 91, 03, 15', emoji: '🐑', color: 'bg-stone-500/10 hover:bg-stone-500/20', borderColor: 'border-stone-500/30' },
    { name: '원숭이띠', year: '신(申)', years: '56, 68, 80, 92, 04, 16', emoji: '🐵', color: 'bg-yellow-500/10 hover:bg-yellow-500/20', borderColor: 'border-yellow-500/30' },
    { name: '닭띠', year: '유(酉)', years: '57, 69, 81, 93, 05, 17', emoji: '🐔', color: 'bg-fuchsia-500/10 hover:bg-fuchsia-500/20', borderColor: 'border-fuchsia-500/30' },
    { name: '개띠', year: '술(戌)', years: '58, 70, 82, 94, 06, 18', emoji: '🐶', color: 'bg-blue-500/10 hover:bg-blue-500/20', borderColor: 'border-blue-500/30' },
    { name: '돼지띠', year: '해(亥)', years: '59, 71, 83, 95, 07, 19', emoji: '🐷', color: 'bg-pink-500/10 hover:bg-pink-500/20', borderColor: 'border-pink-500/30' },
];
        ...
        >
            ...
            <div className="w-full max-w-6xl grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 relative z-10">
                {zodiacSigns.map((sign) => (
                    <Link
                        key={sign.name}
                        href="https://search.naver.com/search.naver?query=%EB%9D%A0%EB%B3%84%EC%9A%B4%EC%84%B8"
            ...
            <div className="mt-16 text-stone-400 text-sm flex items-center gap-2 font-medium z-10 bg-white/50 backdrop-blur-sm py-2 px-4 rounded-full border border-stone-200">
                <span>💡 운세 정보는 네이버 운세 검색 결과로 연결됩니다.</span>
            </div>
        </div>
    );
}

...
export default function JoonggonaraPage() {
 ...
 {/* Customer Center */}
 <Link
 href="https://web.joongna.com/cs-center"
 className="group relative flex items-center justify-between bg-zinc-900/50 hover:bg-zinc-800/80 backdrop-blur-xl border border-white/5 hover:border-amber-500/30 p-5 pr-6 rounded-2xl transition-all duration-300 overflow-hidden shadow-2xl active:scale-[0.98] animate-custom-pulse"
 >
 ...
 <div className="flex flex-col items-start justify-center">
 <span className="text-amber-400 text-xs font-semibold tracking-wider">SUPPORT</span>
 <span className="text-white font-bold text-lg md:text-xl tracking-tight">중고나라 고객센터</span>
 </div>
 </div>

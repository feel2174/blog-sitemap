...
export const metadata = {
    title: '엠게임 바로가기 및 모바일 앱 다운로드',
    description: '엠게임 바둑, 장기, 오목, 맞고, 포커 바로가기 및 모바일 앱 다운로드 링크.',
};

export default function MgameLandingPage() {
    return (
        <div
            ...
            <div className="relative z-10 w-full max-w-md text-center">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', margin: '30px 0' }}>
                    ...
                    <div style={{ backgroundColor: 'red', borderRadius: '12px', textAlign: 'center', animation: 'pulse-nhis 2s infinite', padding: '18px' }}>
                        <Link href="https://www.mgame.com/" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 'bold', fontSize: '18px', display: 'block' }}>
                            엠게임 바로가기
                        </Link>
                    </div>
                    ...
                    <div style={{ backgroundColor: 'red', borderRadius: '12px', textAlign: 'center', animation: 'pulse-nhis 2s infinite', padding: '18px', animationDelay: '0.1s' }}>
                        <Link href="https://gostop.mgame.com/?gWebName=godori3&mainMX=godori3" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 'bold', fontSize: '18px', display: 'block' }}>
                            엠게임 맞고 바로가기
                        </Link>
                    </div>
                    ...
                    <div style={{ backgroundColor: 'red', borderRadius: '12px', textAlign: 'center', animation: 'pulse-nhis 2s infinite', padding: '18px', animationDelay: '0.2s' }}>
                        <Link href="https://baduk.mgame.com/?mainMX=baduk" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 'bold', fontSize: '18px', display: 'block' }}>
                            엠게임 바둑 바로가기
                        </Link>
                    </div>
                    ...
                    <div style={{ backgroundColor: 'red', borderRadius: '12px', textAlign: 'center', animation: 'pulse-nhis 2s infinite', padding: '18px', animationDelay: '0.3s' }}>
                        <Link href="https://omok.mgame.com/?mainMX=omok" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 'bold', fontSize: '18px', display: 'block' }}>
                            엠게임 오목 바로가기
                        </Link>
                    </div>
                    ...
                    <div style={{ backgroundColor: 'red', borderRadius: '12px', textAlign: 'center', animation: 'pulse-nhis 2s infinite', padding: '18px', animationDelay: '0.4s' }}>
                        <Link href="https://poker.mgame.com/?gWebName=newpoker&mainMX=newpoker" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 'bold', fontSize: '18px', display: 'block' }}>
                            엠게임 포커 바로가기
                        </Link>
                    </div>

                    {/* 엠게임 장기 앱 다운로드 */}
                    <div style={{ backgroundColor: 'red', borderRadius: '12px', textAlign: 'center', animation: 'pulse-nhis 2s infinite', padding: '18px', animationDelay: '0.5s' }}>
                        <Link href="https://play.google.com/store/apps/details?id=com.mgamecorp.mgamejanggi&pcampaignid=web_share" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 'bold', fontSize: '18px', display: 'block' }}>
                            엠게임 장기 앱 다운로드
                        </Link>
                    </div>

                    {/* 엠게임 바둑 앱 다운로드 */}
                    <div style={{ backgroundColor: 'red', borderRadius: '12px', textAlign: 'center', animation: 'pulse-nhis 2s infinite', padding: '18px', animationDelay: '0.6s' }}>
                        <Link href="https://play.google.com/store/apps/details?id=com.mgamecorp.mgamebaduk&hl=ko" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 'bold', fontSize: '18px', display: 'block' }}>
                            엠게임 바둑 앱 다운로드
                        </Link>
                    </div>

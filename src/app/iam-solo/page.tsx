...
export const metadata = {
    title: '나는솔로 30기 출연진 인스타 | 영숙 순자 옥순 정숙 현숙',
    description: '나는솔로(나는 SOLO) 30기 출연진 (영숙, 현숙, 순자, 정숙, 옥순, 영수, 영호, 영식, 광수, 상철) 인스타그램 주소 (SNS) 링크 모음.',
};
            ...
            <div className="w-full max-w-5xl text-center mb-16 relative">
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="text-4xl sm:text-6xl font-black text-slate-900 tracking-tight mb-5 leading-tight flex flex-col sm:inline-block">
                        ...
                        <span className="sm:ml-4 text-3xl sm:text-5xl">30기 인스타</span>
                    </h1>
                    
                    <p className="text-slate-600 font-medium text-base sm:text-lg max-w-2xl mx-auto break-keep leading-relaxed mt-4">
                        화제의 <strong className="text-pink-500">나는솔로 30기</strong> 출연진들의 일상을 엿볼 수 있는 <br className="hidden sm:block"/>
                ...
                <div className="mb-16">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h2 className="text-2xl sm:text-3xl font-black text-pink-600 flex items-center gap-2">
                            <span className="text-2xl">👩</span> 솔로녀
                        </h2>
                ...
                <div className="mb-12">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h2 className="text-2xl sm:text-3xl font-black text-blue-600 flex items-center gap-2">
                            <span className="text-2xl">👨</span> 솔로남
                        </h2>

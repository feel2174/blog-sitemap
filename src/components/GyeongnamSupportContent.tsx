...
export default function GyeongnamSupportContent() {
 ...
 <span className="px-3 py-1 sm:px-4 sm:py-1.5 bg-amber-500 text-white rounded-full text-xs sm:text-sm font-black mb-4 sm:mb-6 animate-bounce shadow-lg shadow-amber-500/30">
 도민을 위한 든든한 지원 🤝
 </span>
